...
--
-- Hôte : localhost
-- Généré le :  mar. 14 jan. 2020 à 08:21
...
--
-- Structure de la table `currier_infos`
--
...
--
-- Déchargement des données de la table `currier_infos`
--
...
--
-- Structure de la table `currier_product_infos`
--
...
--
-- Déchargement des données de la table `currier_product_infos`
--
...
CREATE TABLE `drivers` (
  ...
  `identity_number` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rib` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'staff', 'staff@gmail.com', '454564', 'address de test, staff', NULL, NULL, '$2y$10$tDNcb7MfvPaT4IXN0GLwtOD.kqZlzHOBY0.PRPCreWh0Ha6FYMBlW', 'Staff', 'Active', 1, 'lC55dVmB3cxch62c1vMPuOXUaXw8VHT2YxqNIDLGNYTa3J5gn31hO2WAsjF0', NULL, '2019-12-01 22:14:07', '2020-01-10 14:01:37'),
...
(11, 'Staff it', 'staffit@gmail.com', '0676478594', NULL, '', NULL, '$2y$10$ReTbE.ec98BowI6MVeV07ugMi03TROcSDYX8lK2C3HQmDIIDf975m', 'Staff', 'Inactive', 1, 'cx78oi9balBuEd6j3HCZlG6yqpvj5TbgNm5Ls0XAZhQ1UI5FEL2sSqA3p2ia', NULL, '2020-01-12 08:57:53', '2020-01-12 08:57:53'),
(12, 'Mohamed', 'mohamed@cmaroc.com', '0676479581', NULL, NULL, NULL, '$2y$10$ReTbE.ec98BowI6MVeV07ugMi03TROcSDYX8lK2C3HQmDIIDf975m', 'Manager', 'Active', 1, 'qcIIdRRMk5CDKWpcYRjkeDK6Rl1caofmE1VqFVxYfKd6KMUn52Zpwccb8BfR', NULL, '2020-01-12 12:09:24', '2020-01-12 12:09:24');
...
--
-- Index pour la table `courier_types`
--
...
--
-- Index pour la table `currier_infos`
--
...
--
-- Index pour la table `currier_product_infos`
--
...
--
-- AUTO_INCREMENT pour la table `courier_types`
--
ALTER TABLE `courier_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `currier_infos`
--
ALTER TABLE `currier_infos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `currier_product_infos`
--
ALTER TABLE `currier_product_infos`
...
--
-- Contraintes pour la table `currier_infos`
--
ALTER TABLE `currier_infos`
...
--
-- Contraintes pour la table `currier_product_infos`
--
ALTER TABLE `currier_product_infos`
