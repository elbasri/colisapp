...
class CustomerController extends Controller {
    ...
    public function dashboard() {
        ...
        return view('customer/dashboard',  compact('user', 'totalBranch', 'totalManager', 'totalCompanyIncome', 'total_chart'));
    }
    ...
    public function add() {
        ...
        return view('customer/colisInfo/add', compact('priceList', 'branchList', 'colisTypeList', 'gs'));
    }
    ...
    public function updateProfile(Request $request) {
        ...
        if ($request->hasFile('image')) {
            if (Auth::user()->image) {
                unlink('assets/customer/img/profile/' . Auth::user()->image);
            }
            $image = $request->image;
            $imageObj = Image::make($image);
            $imageObj->save('assets/customer/img/profile/' . $image->hashname());
    ...
    public function branchList() {
        ...
        return view('customer.allbranch', compact('branchList'));
    }
