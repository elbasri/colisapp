...
class FrontendSettingController extends Controller {
    ...
    public function prices() {
        ...
        return view('admin.frontendSetting.price', compact('setting', 'pricesList'));
    }

    public function pricesUpdate(Request $request) {
        $request->validate([
            'price_city' => 'required|max:255',
        ]);
        $setting = GeneralSetting::first();
        $data = $request->all();
        $setting->update($data);
    ...
    public function storeNewPrices(Request $request, Price $price) {
        $request->validate([
            'city' => 'required',
    ...
    public function updateNewPrices(Request $request, Price $prices) {
        $request->validate([
            'city' => 'required',
            'price' => 'required|max:150',
        ]);
