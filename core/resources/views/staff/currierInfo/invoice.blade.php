...
<div class="content p-4">
    ...
    <div class="card">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th class="center">#</th>
                                    <th>{{__('Courier Type')}}</th>
                                    <th>{{__('Sending Date')}}</th>
                                    <th>{{__('Courier Quantity')}}</th>
                                    <th>{{__('Courier Fee')}}</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div class="row mb-2 ml-2">
            <div class="container">
                <button type="button" onclick="printDiv();" value="print" class="btn btn-info razu"><i class="fa fa-print"></i>&nbsp;{{__('Print Courier')}}</button>
                <a href="{{ route('staff.currier.slip',$currierInfo->id) }}" target="_blank"><button class="btn btn-primary"><i class="fa fa-print"></i> {{__('Print Slip')}}</button></a> 
                @if($currierInfo->payment_status == 'Unpaid')
                                    ...
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('currier.payment.staff') }}">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="receive{{ $currierInfo->id }}"><i class="fa fa-download"></i>&nbsp;{{__('Make Payment')}}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">
                                                <h5 class="text-danger text-center font-weight-bold">{{__('Please Collect')}} {{ $currierInfo->payment_balance }}&nbsp;{{ $gs->base_currency }}</h5>
