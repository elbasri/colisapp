                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="faq" href="{{ route('front.faq') }}">{{__('How Its Work')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact" href="{{ route('front.contactus') }}">{{__('Contact Us')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="btnlinks" id="login" href="{{ route('login') }}"><span class="btn btnlogin">{{__('Login')}}</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="btnlinks" id="signup" href="{{ route('signup') }}"><span class="btn btnsignup">{{__('Sign up')}}</span></a>
                            </li>
