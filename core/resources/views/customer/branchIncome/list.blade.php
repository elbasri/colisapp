...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{ Auth::user()->name }} {{__('Cash Collection List')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <form method="GET" action="{{ route('customer.cashe.collection') }}" class="form-inline">
                        @csrf
            ...
            <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                ...
                <tbody >
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center">{{__('No Information')}}</td>
                    </tr>
                    @endforelse
