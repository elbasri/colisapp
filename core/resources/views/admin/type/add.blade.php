...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Create New Type')}}
        <a href="{{ route('type.index') }}" class="btn btn-primary btn-md float-right">
            <i class="fa fa-list"></i>   {{__('View Type')}}
        </a>
    </h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('type.store') }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="unit_id" style="text-transform: uppercase;"><strong>{{__('Unit')}}&nbsp;<span class="mark">*</span></strong></label>
                ...
                <div class="col-md-12  container-fluid">
                    <div class="form-group">
                        <label for="price" style="text-transform: uppercase;"><strong>{{__('Price')}}&nbsp;<span class="mark">*</span></strong></label>
                ...
                <br>
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary btn-block btn-lg">{{__('Create New Type')}}</button>
                </div>
            </form>
        </div>
    </div>
