...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Create Branch Manager')}}
        <a href="{{ route('branchmanager.index') }}" class="btn btn-primary btn-md float-right">
            <i class="fa fa-list"></i>{{__('View Branch Manager')}}   
        </a>
    </h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('branchmanager.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="branch_id" style="text-transform: uppercase;"><strong>{{__('Branch Name')}}&nbsp;<span class="mark">*</span></strong></label>
                ...
                <div class="col-md-12  container-fluid">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg mb-3" type="text" name="name"  value="{{ old('name') }}" placeholder="{{__('Branch Manager Name')}}">
                    </div>
                </div>
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                        <label for="email" style="text-transform: uppercase;"><strong>{{__('Email')}}&nbsp;<span class="mark">*</span></strong></label>
                        <input class="form-control form-control-lg mb-3" type="email" name="email"  value="{{ old('email') }}" placeholder="{{__('Branch Manager Email')}}">
                    </div>
                </div>
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                        <label for="phone" style="text-transform: uppercase;"><strong>{{__('Phone')}}</strong></label>
                        <input class="form-control form-control-lg mb-3" type="text" name="phone"  value="{{ old('phone') }}" placeholder="{{__('Branch Manager Phone')}}">
                    </div>
                </div>
                <div class="col-md-12  container-fluid">
                    <div class="form-group">
                        <label for="password" style="text-transform: uppercase;"><strong>{{__('Password')}}&nbsp;<span class="mark">*</span></strong></label>
                        <input type="password" class="form-control form-control-lg mb-3"  id="password" name="password" placeholder="{{__('Branch Manager Password')}}">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <br>
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary btn-block btn-lg">{{__('Create New Manager')}}</button>
                </div>
            </form>
        </div>
    </div>
