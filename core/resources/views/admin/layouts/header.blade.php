                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd_user">
                            <a href="{{ route('admin.profile') }}" class="dropdown-item"><i class="fa fa-user"></i> {{__('Profile')}}</a>
                            <a href="{{ url('admin/changePassword') }}" class="dropdown-item"><i class="fa fa-cog"></i> {{__('Change Password')}}</a>
                            <a href="#"  class="dropdown-item"onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-angle-left"></i> {{__('Logout')}}</a>
