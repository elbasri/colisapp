            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">{{__('Total Branch')}}</p>
                ...
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">{{__('Total Manager')}}</p>
                ...
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">{{__('Total Company Income')}}</p>
