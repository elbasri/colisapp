...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Logo & Icon Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row  container-fluid">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="logo" style="text-transform: uppercase;"><strong>{{__('Logo')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" type="file" name="logo" >
                            <small class="text-danger h6">[{{__('Image format: PNG')}}]</small>
                        </div>
                        <img style="height: 100px;" class="thumbnail img-responsive" src="{{asset('assets/frontend/images/logo.png')}}"/>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="favicon_icon" style="text-transform: uppercase;"><strong>{{__('Favicon Icon')}}</strong></label>
