...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Feature  Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.featureSection') }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="feature_title" style="text-transform: uppercase;"><strong>{{__('Feature  Title')}}</strong></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="feature_subtitle" style="text-transform: uppercase;"><strong>{{__('Feature  Subtitle')}}</strong></label>
