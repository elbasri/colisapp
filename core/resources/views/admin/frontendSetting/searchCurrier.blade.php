                    ...
                    <form action="{{ route('frontend.searchcurrier') }}" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="search_currier_title" style="text-transform: uppercase;"><strong>{{__('Title')}}</strong></label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="search_currier_details" style="text-transform: uppercase;"><strong>{{__('Details')}}</strong></label>
