...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Currier Count Info Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row  container-fluid">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="departure_currier" style="text-transform: uppercase;"><strong>{{__('Departure Currier')}}</strong></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="upcoming_currier" style="text-transform: uppercase;"><strong>{{__('Upcoming Currier')}}</strong></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="total_deliver" style="text-transform: uppercase;"><strong>{{__('Total Deliver Currier')}}</strong></label>
