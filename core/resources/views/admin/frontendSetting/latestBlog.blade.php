...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Latest Blog Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.latestBlog') }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="blog_title" style="text-transform: uppercase;"><strong>{{__('Latest Blog Title')}}</strong></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="blog_details" style="text-transform: uppercase;"><strong>{{__('Latest Blog Details')}}</strong></label>
