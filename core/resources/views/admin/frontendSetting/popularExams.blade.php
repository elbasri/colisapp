...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Popular Exam Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.popularExamUpdate',$setting->id) }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="popular_exam_title" style="text-transform: uppercase;"><strong>{{__('Popular Exam Title')}}</strong></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="popular_exam_details" style="text-transform: uppercase;"><strong>{{__('Popular Exam Details')}}</strong></label>
