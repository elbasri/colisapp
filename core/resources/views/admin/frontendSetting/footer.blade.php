...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Footer Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.footer') }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="footer_text" style="text-transform: uppercase;"><strong>{{__('Footer Text')}}</strong></label>
