...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Join Us Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.joinus') }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="join_us_title" style="text-transform: uppercase;"><strong>{{__('Join Us Title')}}</strong></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="join_us_details" style="text-transform: uppercase;"><strong>{{__('Join Us Details')}}</strong></label>
