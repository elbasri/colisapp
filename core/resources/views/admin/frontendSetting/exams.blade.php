...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Exams Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.exams') }}" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exams_title" style="text-transform: uppercase;"><strong>{{__('Exams Title')}}</strong></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exams_details" style="text-transform: uppercase;"><strong>{{__('Exams Details')}}</strong></label>
