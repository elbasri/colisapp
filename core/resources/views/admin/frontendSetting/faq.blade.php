...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Faq Setting')}}
                    ...
                    <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" style="text-transform: uppercase">&nbsp; {{__('Answer Details')}} </h5>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="editFaq{{ $faq->id }}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-share-square"></i> {{__('Edit Faq')}}</h4>
                                                ...
                                                <form method="POST" action="{{ route('frontend.updateFaq',$faq->id) }}">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="question" class="col-sm-3 control-label bold uppercase"><strong>{{__('Question')}} :</strong> </label>
                                                                <div class="col-sm-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="answer" class="col-sm-3 control-label bold uppercase"><strong>{{__('Answer')}} :</strong> </label>
                                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary bold uppercase"><i class="fas fa-arrow-alt-circle-up"></i> {{__('Update Faq')}}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-share-square"></i> {{__('Add New Faq')}}</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <form method="POST" action="{{ route('frontend.storeFaq') }}">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-info" data-dismiss="modal"><i class="fa fa-times"></i> {{__('Close')}}</button>
                                            <button type="submit" class="btn btn-primary bold uppercase"><i class="fas fa-arrow-alt-circle-up"></i> {{__('Save Faq')}}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
