...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Banner Text Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('frontend.headertextupdate',$setting->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="header_title" style="text-transform: uppercase;"><strong>{{__('Banner Text Title')}}</strong></label>
                        <input class="form-control form-control-lg mb-3" name="header_title" value="{{ $setting->header_title ?? old('header_title') }}"  type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="header_subtitle" style="text-transform: uppercase;"><strong>{{__('Banner Text Sub Title')}}</strong></label>
