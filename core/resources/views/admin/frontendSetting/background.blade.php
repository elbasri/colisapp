...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Background Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row  container-fluid">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="header_background_image" style="text-transform: uppercase;"><strong>{{__('Banner Background Image')}}</strong></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="testimonial_background_image" style="text-transform: uppercase;"><strong>{{__('Testimonial Background Image')}}</strong></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="breadcumb_background_image" style="text-transform: uppercase;"><strong>{{__('Breadcumb Background Image')}}</strong></label>
