...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('About us Setting')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="aboutus_title" style="text-transform: uppercase;"><strong>{{__('About us Title')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="about_us_quote_one" style="text-transform: uppercase;"><strong>{{__('About us Quote One')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="about_us_quote_two" style="text-transform: uppercase;"><strong>{{__('About us Quote Two')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="about_us_quote_three" style="text-transform: uppercase;"><strong>{{__('About us Quote Three')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="aboutus_details" style="text-transform: uppercase;"><strong>{{__('About us Details')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="aboutus_image" style="text-transform: uppercase;"><strong>{{__('About us Image')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" type="file" name="aboutus_image" >
                            <small class="text-danger h6">{{__('Image will be resize at 530*482 [Image format: JPG,JPEG]')}}</small>
                        </div>
