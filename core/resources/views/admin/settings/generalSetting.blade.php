...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Basic Settings')}}</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('admin.basicSettingUpdate',$settings->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row container-fluid">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="title" style="text-transform: uppercase;"><strong>{{__('Website Title')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" name="title" value="{{ $settings->title ?? old('title') }}"  type="text">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>{{__('Site Base Color Code')}}</strong></label>
                ...
                <div class="row  container-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="base_currency" style="text-transform: uppercase;"><strong>{{__('Base Currency Text')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>{{__('Base Currency Symbol')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="registration_verification" style="text-transform: uppercase;"><strong>{{__('Enable Registration')}}?</strong></label>
                            <input type="checkbox" data-onstyle="success" data-offstyle="danger" data-width="100%"  data-toggle="toggle" name="registration_verification"  {{ $settings->registration_verification==1 ? 'checked' : '' }}>
                        </div>
                    </div> 
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="sms_verification" style="text-transform: uppercase;"><strong>{{__('SMS NOTIFICATION')}}</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="email_verification" style="text-transform: uppercase;"><strong>{{__('EMAIL NOTIFICATION')}}</strong></label>
