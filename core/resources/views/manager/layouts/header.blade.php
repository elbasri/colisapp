...
<html lang="en">
    ...
    <body class="bg-light" id="test">
        <nav class="navbar navbar-expand navbar-dark bg-custom-background">
            ...
            <a class="navbar-brand" href="#">{{__('Branch Manager Panel')}}</a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd_user">
                            <a href="{{ route('manager.profile') }}" class="dropdown-item"><i class="fa fa-user"></i> {{__('Profile')}}</a>
                            <a href="{{ route('manager.changepassword') }}" class="dropdown-item"><i class="fa fa-cog"></i> {{__('Change Password')}}</a>
