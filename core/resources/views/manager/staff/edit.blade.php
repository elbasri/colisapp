...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Edit Branch Staff')}}
                ...
                <div class="row">
                    <div class="col-md-12  container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" name="name"  value="{{ $branchstaff->name ?? old('name') }}" placeholder="{{__('Branch Staff Name')}}">
                        </div>
                    </div>
                    <div class="col-md-12 container-fluid">
                        <div class="form-group">
                            <label for="email" style="text-transform: uppercase;"><strong>{{__('Email')}}&nbsp;<span class="mark">*</span></strong></label>
                            <input class="form-control form-control-lg mb-3" type="email" name="email"  value="{{ $branchstaff->email ?? old('email') }}" placeholder="{{__('Branch Staff Email')}}">
                        </div>
                    </div>
                    <div class="col-md-12 container-fluid">
                        <div class="form-group">
                            <label for="phone" style="text-transform: uppercase;"><strong>{{__('Phone')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" type="text" name="phone"  value="{{ $branchstaff->phone ?? old('phone') }}" placeholder="{{__('Branch Staff Phone')}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
