...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Create Branch Driver')}}
        <a href="{{ route('driver.index') }}" class="btn btn-primary btn-md float-right">
            <i class="fa fa-list"></i>{{__('View Branch Driver')}}   
        </a>
    </h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6  container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" name="name"  value="{{ old('name') }}" placeholder="{{__('Branch Driver Name')}}">
                    ...
                    <div class="col-md-6 container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg mb-3" type="email" name="email"  value="{{ old('email') }}" placeholder="{{__('Branch Driver Email')}}">
                        </div>
                    </div>
                    <div class="col-md-6 container-fluid">
                        <div class="form-group">
                            <label for="phone" style="text-transform: uppercase;"><strong>{{__('Phone')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" type="text" name="phone"  value="{{ old('phone') }}" placeholder="{{__('Branch Driver Phone')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="password" style="text-transform: uppercase;"><strong>{{__('Password')}}&nbsp;<span class="mark">*</span></strong></label>
                            <input type="password" class="form-control form-control-lg mb-3"  id="password" name="password" placeholder="{{__('Branch Driver Password')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#branchDriver li:nth-child(1)").addClass("active");
</script>
@endsection