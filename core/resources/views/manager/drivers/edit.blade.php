                ...
                <div class="row">
                    <div class="col-md-12  container-fluid">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg mb-3" type="text" name="name"  value="{{ $branchcustomer->name ?? old('name') }}" placeholder="Branch Customer Name">
                        </div>
                    </div>
                    <div class="col-md-12 container-fluid">
                        <div class="form-group">
                            <label for="email" style="text-transform: uppercase;"><strong>{{__('Email')}}&nbsp;<span class="mark">*</span></strong></label>
                            <input class="form-control form-control-lg mb-3" type="email" name="email"  value="{{ $branchcustomer->email ?? old('email') }}" placeholder="Branch Customer Email">
                        </div>
                    </div>
                    <div class="col-md-12 container-fluid">
                        <div class="form-group">
                            <label for="phone" style="text-transform: uppercase;"><strong>{{__('Phone')}}</strong></label>
                            <input class="form-control form-control-lg mb-3" type="text" name="phone"  value="{{ $branchcustomer->phone ?? old('phone') }}" placeholder="Branch Customer Phone">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
