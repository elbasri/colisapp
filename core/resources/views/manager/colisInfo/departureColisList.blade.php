...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{__('Departure Colis List')}}
    </h2>
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
            ...
            <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('manager.departure.invoice',$colis->invoice_id) }}"><button class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i> {{__('Colis Invoice')}}</button></a>  
                        </td> 
                    </tr>
                    @empty
                    <tr>
