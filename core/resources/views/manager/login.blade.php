...
<html lang="en">
    <head>
        ...
        <title>{{__('Branch Manager Panel')}}</title>
    </head>
    <body class="bg-info">
            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-5">
                    ...
                    <div class="card border border-success">
                        <div class="card-header  text-white text-uppercase h4" style="background: #173C5A;">{{__('Branch Manager Login Form')}}</div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" placeholder="{{__('Username')}}" value="manager">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{__('Password')}}" value="manager">
